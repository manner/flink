...
public class TestClusterStarter {
	...
	public static void startCluster() {
		...
		System.out.println("==================");
		//hbaseConf.set("hbase.fs.tmp.dir",	"hdfs://127.0.0.1:64771/user/Leon Bein/test-data/d24ffa6b-b9a8-18b8-79d0-9430d327d07b/hbase-staging");
		//hbaseConf.set("hbase.rootdir", 		"hdfs://127.0.0.1:64771/user/Leon Bein/test-data/d24ffa6b-b9a8-18b8-79d0-9430d327d07b");
		//hbaseConf.set("fs.defaultFS", 		"hdfs://127.0.0.1:64771/user/Leon Bein/test-data/d24ffa6b-b9a8-18b8-79d0-9430d327d07b");
