...
public class Consumer extends AbstractRegionServer {
	...
	public Consumer(
		...
		ZooKeeperItf zk) throws IOException {
	...
	public static void main(String[] args) throws IOException, ZkConnectException, KeeperException, InterruptedException {
		...
		admin
			.listReplicationPeers()
			.forEach(replicationPeerDescription -> System.out.println(replicationPeerDescription.toString()));
	...
	public static Configuration parseConfig() throws SAXException, IOException, ParserConfigurationException {
